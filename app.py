...
# O Render vai ler o Token e o ID direto do painel (Environment)
TOKEN_TELEGRAM = os.environ.get("TOKEN_TELEGRAM", "8351646305:AAFCN6_ymS3Qb8kA4PxqyfT7x0Zi-bpTokA")
CHAT_ID_TELEGRAM = os.environ.get("CHAT_ID_TELEGRAM", "-1003879813604")

TICKER_OURO = "GC=F" 
ARQUIVO_MEMORIA = "memoria_ia_evolutiva.json"

def enviar_alerta_telegram(mensagem):
    # CORREÇÃO: URL oficial da API do Telegram corrigida
    url = f"https://telegram.org{TOKEN_TELEGRAM}/sendMessage"
    
    # CORREÇÃO: Variável corrigida de 'message' para 'mensagem'
...
def salvar_memoria():
    # CORREÇÃO: Corrigido de ARQUEMA_MEMORIA para ARQUIVO_MEMORIA
...
def processar_ciclo_ia():
    ...
    if df.empty: 
        print("[Aviso]: Dados do Yahoo Finance vazios.")
        return
